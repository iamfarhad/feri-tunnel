...
show_menu() {
    ...
    echo -e "${YELLOW}6. Optimize the Network settings${NC}"
    echo -e "${YELLOW}7. Optimize the System Limits${NC}"
    echo -e "${YELLOW}8. Install Or Update Gost v3${NC}"
    echo -e "${YELLOW}9. Create Gost tunnel ipv6 (single-multi port)${NC}"
    echo -e "${YELLOW}10. Create Gost tunnel ipv6 (range-port)${NC}"
